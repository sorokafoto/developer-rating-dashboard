...
|-----|------|-----------------|----------------|
| Как быстро перезванивают? | `avg_call_response` | медиана минут до первого идентифицированного звонка | `market.avg_call_response.mean`, `.best` |
| Заявки без идентифицированного звонка | `no_call_share` | % заявок без звонка за 72 ч | `market.no_call_share.mean` |
| Среднее касаний на заявку | derived / `company-events` | касания в рейтинге ÷ все отправленные заявки | — |
